          ...
          >
            <div className="flex items-start gap-6 text-sm">
              ...
              <div>
                ...
                <p className="mt-2">
                  Date: <span className="text-gray-400">13, April, 2026</span>
                </p>
              </div>
            </div>
            ...
            <div className="md:w-1/2 flex justify-between">
              ...
              <button className="border px-4 py-2 text-sm font-medium rounded-sm hover:bg-black hover:text-white transition-all">
                Track Order
              </button>
            </div>
          </div>
